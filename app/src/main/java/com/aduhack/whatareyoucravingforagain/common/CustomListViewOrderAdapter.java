    ...
    public class CustomListViewOrderAdapter extends BaseAdapter{
	...
	public CustomListViewOrderAdapter(Context context, ArrayList<ListViewAdapterModelWithAvatar> items) {
		_context = context;
		_items = items;
